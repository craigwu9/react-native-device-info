...
public class RNDeviceModule extends ReactContextBaseJavaModule {
    ...
    Map<String, Object> getConstants() {
        ...
        constants.put("uniqueIdType", this.getUniqueIDType());
    ...
    public String getUniqueID() {
        ...
        if (imei != null && !imei.startsWith("000")) {
            ...
            if (androidId != null && !androidId.startsWith("000")) {
                ...
                this.uniqueIdType = "ANDROID_ID";
            } else {
                String uid = "";
                try {
                    PackageManager pm = reactContext.getPackageManager();
                    @SuppressLint("WrongConstant") ApplicationInfo ai = pm.getApplicationInfo(reactContext.getPackageName(), PackageManager.GET_ACTIVITIES);
                    uid = ai.uid + "";
                    this.uniqueId = uid;
                    this.uniqueIdType = "UID";
                } catch (PackageManager.NameNotFoundException e) {
                    e.printStackTrace();
                }
